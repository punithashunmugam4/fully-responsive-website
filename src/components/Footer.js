  ...
  return (
    <div className='footer-container'>
      ...
      <div className="footer-links">
        <div className="footer-linnk-wrapper">
      ...
      <section className='social-media'>
        <div className="social-media-wrap">
            ...
            <small className='website-rights'>PS © 2020</small>
            <div className='social-icons'>
                <Link className='social-icon-link facebook' to='/' target='_blank'
                aria-label='Facebook'><i className='fab fa-facebook-f'/></Link>
                <Link className='social-icon-link instagram' to='/' target='_blank'
                aria-label='Instagram'><i className='fab fa-instagram'/></Link>
